    ...
    return (
        <div id="faq" className=" p-5 my-10 ">
            ...
            <div className="md:w-8/12 mx-auto ">
                <div className="collapse collapse-arrow bg-blue-400">
                ...
                <div className="collapse collapse-arrow bg-blue-400  my-5">
                ...
                <div className="collapse collapse-arrow bg-blue-400 mb-10">
                    <input type="radio" name="my-accordion-2" />
